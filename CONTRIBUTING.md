...
- All code should be typed when possible.
  ...
  - Create all custom types in `env_config/typing.py` and import them from there.
    This avoids circular imports.
  - Use of `TypedDict` is encouraged where dicts would be used.
  - Also import common types like `List` from `env_config/typing.py` instead of the built-in `typing` module.
